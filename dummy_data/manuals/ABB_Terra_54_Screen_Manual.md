...
**Target Part:** 15-inch Capacitive Touch Screen
...
When a failure occurs in the 15-inch Capacitive Touch Screen, the system will typically issue the error code `ERR-HMI-BLK` to the central operations dashboard. 
...
*   Replacement 15-inch Capacitive Touch Screen
...
2. If `ERR-HMI-BLK` persists after boot sequence, proceed with physical inspection.
...
3. Locate the 15-inch Capacitive Touch Screen inside the chassis.

**Step 4.3: Diagnostic Testing**
1. Disconnect the logic/control cables from the 15-inch Capacitive Touch Screen.
...
3. *Recommendation: Replace LVDS cable from mainboard*

**Step 4.4: Replacement**
1. Unplug the main harness. 
2. Slide the 15-inch Capacitive Touch Screen out of the bracket. 
...
3. Ping the charger from the diagnostic technician app to verify `ERR-HMI-BLK` has cleared.
