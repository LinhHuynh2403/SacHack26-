...
**Component Category:** Mount
**Target Part:** Bollard Mounting Base
...
When a failure occurs in the Bollard Mounting Base, the system will typically issue the error code `CP-ERR-TIL` to the central operations dashboard. 
...
*   Replacement Bollard Mounting Base
...
2. If `CP-ERR-TIL` persists after boot sequence, proceed with physical inspection.
...
3. Locate the Bollard Mounting Base inside the chassis.

**Step 4.3: Diagnostic Testing**
1. Disconnect the logic/control cables from the Bollard Mounting Base.
...
3. *Recommendation: Re-torque anchor bolts to 50 ft-lbs*

**Step 4.4: Replacement**
1. Unplug the main harness. 
2. Slide the Bollard Mounting Base out of the bracket. 
...
3. Ping the charger from the diagnostic technician app to verify `CP-ERR-TIL` has cleared.
