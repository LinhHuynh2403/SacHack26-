...
**Target Part:** Supercharger Cabinet AC/DC Converter
...
When a failure occurs in the Supercharger Cabinet AC/DC Converter, the system will typically issue the error code `VC-CAB-ACDC` to the central operations dashboard. 
...
*   Replacement Supercharger Cabinet AC/DC Converter
...
2. If `VC-CAB-ACDC` persists after boot sequence, proceed with physical inspection.
...
3. Locate the Supercharger Cabinet AC/DC Converter inside the chassis.

**Step 4.3: Diagnostic Testing**
1. Disconnect the logic/control cables from the Supercharger Cabinet AC/DC Converter.
...
3. *Recommendation: Check busbar torque, inspect IGBT modules*

**Step 4.4: Replacement**
1. Unplug the main harness. 
2. Slide the Supercharger Cabinet AC/DC Converter out of the bracket. 
...
3. Ping the charger from the diagnostic technician app to verify `VC-CAB-ACDC` has cleared.
