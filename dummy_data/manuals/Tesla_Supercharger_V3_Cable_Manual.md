...
**Target Part:** Liquid-Cooled NACS Cable
...
When a failure occurs in the Liquid-Cooled NACS Cable, the system will typically issue the error code `VC-CBL-LIQ` to the central operations dashboard. 
...
*   Replacement Liquid-Cooled NACS Cable
...
2. If `VC-CBL-LIQ` persists after boot sequence, proceed with physical inspection.
...
3. Locate the Liquid-Cooled NACS Cable inside the chassis.

**Step 4.3: Diagnostic Testing**
1. Disconnect the logic/control cables from the Liquid-Cooled NACS Cable.
...
3. *Recommendation: Inspect for pin melting, perform dielectric test*

**Step 4.4: Replacement**
1. Unplug the main harness. 
2. Slide the Liquid-Cooled NACS Cable out of the bracket. 
...
3. Ping the charger from the diagnostic technician app to verify `VC-CBL-LIQ` has cleared.
