...
**Target Part:** LTE Cellular Modem (Sierra Wireless)
...
When a failure occurs in the LTE Cellular Modem (Sierra Wireless), the system will typically issue the error code `ERR-NET-4G` to the central operations dashboard. 
...
*   Replacement LTE Cellular Modem (Sierra Wireless)
...
2. If `ERR-NET-4G` persists after boot sequence, proceed with physical inspection.
...
3. Locate the LTE Cellular Modem (Sierra Wireless) inside the chassis.

**Step 4.3: Diagnostic Testing**
1. Disconnect the logic/control cables from the LTE Cellular Modem (Sierra Wireless).
...
3. *Recommendation: Cycle SIM, reseat antenna connections*

**Step 4.4: Replacement**
1. Unplug the main harness. 
2. Slide the LTE Cellular Modem (Sierra Wireless) out of the bracket. 
...
3. Ping the charger from the diagnostic technician app to verify `ERR-NET-4G` has cleared.
