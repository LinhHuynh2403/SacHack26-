...
**Target Part:** Credit Card Terminal
...
When a failure occurs in the Credit Card Terminal, the system will typically issue the error code `TR-CC-NA` to the central operations dashboard. 
...
*   Replacement Credit Card Terminal
...
2. If `TR-CC-NA` persists after boot sequence, proceed with physical inspection.
...
3. Locate the Credit Card Terminal inside the chassis.

**Step 4.3: Diagnostic Testing**
1. Disconnect the logic/control cables from the Credit Card Terminal.
...
3. *Recommendation: Verify heartbeat to banking backend*

**Step 4.4: Replacement**
1. Unplug the main harness. 
2. Slide the Credit Card Terminal out of the bracket. 
...
3. Ping the charger from the diagnostic technician app to verify `TR-CC-NA` has cleared.
