...
**Target Part:** Liquid Cooling Loop Radiator
...
When a failure occurs in the Liquid Cooling Loop Radiator, the system will typically issue the error code `VC-THRM-001` to the central operations dashboard. 
...
*   Replacement Liquid Cooling Loop Radiator
...
2. If `VC-THRM-001` persists after boot sequence, proceed with physical inspection.
...
3. Locate the Liquid Cooling Loop Radiator inside the chassis.

**Step 4.3: Diagnostic Testing**
1. Disconnect the logic/control cables from the Liquid Cooling Loop Radiator.
...
3. *Recommendation: Top off Glycol mix, clear radiator debris*

**Step 4.4: Replacement**
1. Unplug the main harness. 
2. Slide the Liquid Cooling Loop Radiator out of the bracket. 
...
3. Ping the charger from the diagnostic technician app to verify `VC-THRM-001` has cleared.
