...
**Target Part:** 10kW Rectifier Module
...
When a failure occurs in the 10kW Rectifier Module, the system will typically issue the error code `ERR-REC-04` to the central operations dashboard. 
...
*   Replacement 10kW Rectifier Module
...
2. If `ERR-REC-04` persists after boot sequence, proceed with physical inspection.
...
3. Locate the 10kW Rectifier Module inside the chassis.

**Step 4.3: Diagnostic Testing**
1. Disconnect the logic/control cables from the 10kW Rectifier Module.
...
3. *Recommendation: Swap rectifier module, check phase balance*

**Step 4.4: Replacement**
1. Unplug the main harness. 
2. Slide the 10kW Rectifier Module out of the bracket. 
...
3. Ping the charger from the diagnostic technician app to verify `ERR-REC-04` has cleared.
