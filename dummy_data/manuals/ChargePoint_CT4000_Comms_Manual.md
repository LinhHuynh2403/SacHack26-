...
**Target Part:** Wi-Fi / Cellular Node gateway
...
When a failure occurs in the Wi-Fi / Cellular Node gateway, the system will typically issue the error code `CP-ERR-WIFI` to the central operations dashboard. 
...
*   Replacement Wi-Fi / Cellular Node gateway
...
2. If `CP-ERR-WIFI` persists after boot sequence, proceed with physical inspection.
...
3. Locate the Wi-Fi / Cellular Node gateway inside the chassis.

**Step 4.3: Diagnostic Testing**
1. Disconnect the logic/control cables from the Wi-Fi / Cellular Node gateway.
...
3. *Recommendation: Provision new MAC address in backend*

**Step 4.4: Replacement**
1. Unplug the main harness. 
2. Slide the Wi-Fi / Cellular Node gateway out of the bracket. 
...
3. Ping the charger from the diagnostic technician app to verify `CP-ERR-WIFI` has cleared.
